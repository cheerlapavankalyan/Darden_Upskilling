...
public class StudentController {
    ...
    public ResponseEntity<Student> getStudent(){
        ...
        return ResponseEntity.ok().header("custom-header", "pavan").body(student);
    ...
    public ResponseEntity<List<Student>> getStudents(){
        ...
        students.add(new Student(1,"pavan", "kalyan"));
        students.add(new Student(2,"venkatesh", "naga"));
        students.add(new Student(3, "uday", "singh"));
        students.add(new Student(4,"hare", "ram"));
